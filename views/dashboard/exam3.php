...
// Crear instancia del servicio de preguntas y módulo
    ...
    if (isset($_POST['comenzarExamen'])) {
        ...
        if ($todasCorrectas) {
            ...
            echo "<script>
                    ...
                    window.location.href = 'index.php'; // Redirige al siguiente módulo
                  </script>";
        } else {
            $nuevoProgreso = 100;
            $moduleService->updateProgress($userId, $moduleId, $nuevoProgreso);
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Examen Módulo 3</h1>
